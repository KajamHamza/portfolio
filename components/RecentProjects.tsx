            ...
            <PinContainer title={item.title} href={item.url}>
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: "black" }} // Changed background color to black
                >
              ...
              <p
                ...
                style={{
                  color: "#BEC1DD", // You might want to change this to a lighter gray or keep it for contrast
                  margin: "1vh 0",
                }}
              >
                {item.des}
